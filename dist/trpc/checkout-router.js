...
exports.checkoutRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filteredProducts, order;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        order = _b.sent();
                        return [2 /*return*/, { url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(order.id) }];
                }
            });
        });
    }),
