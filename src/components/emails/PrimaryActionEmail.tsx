      ...
      <Html>
        ...
        <Body style={main}>
          <Container style={container}>
            <Img
              src={`${process.env.NEXT_PUBLIC_SERVER_URL}/CosmiMarket-email.png`}
              width='180'
              height='150'
              alt='PRINTINITY'
              style={logo}
            ...
            <Text style={paragraph}>
              Welcome to PRINTINITY, the marketplace for
              high quality cosmetics goods. Use the button below
              to {actionLabel}.
            </Text>
